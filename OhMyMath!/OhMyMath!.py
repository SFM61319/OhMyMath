""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""" #############################################################################################################################################################################################################################################################################################################################################
Authors: M.S.S.Avinash, Harsh Hande                               #############################################################################################################################################################################################################################################################################################################################################
Roll No.: 09, 07                                                  #############################################################################################################################################################################################################################################################################################################################################
Class: XII - B, 2019-2020                                         #############################################################################################################################################################################################################################################################################################################################################
...
def evaluate():   ## Function to evaluate the final expression
    ...
    global expression, equation, approximation
    ...
    if (approximation == None):
        ...
        expression = round(float(evalall(expression)), 3)
...
##################################################
    ...
    #     | |          | |       | |  | |       | |  | |           ! ! !     #
    #     | ---------  | --------  |  | --------  |  | |_________  ! ! !     #
    #     \__________  \__________/   \__________/   |__________|  O O O     #
    #                                                                        #
    #                                                                        #
    ##########################################################################
